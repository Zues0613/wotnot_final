<template>
  <main class="bg-container dark:bg-gray-900">
    <div class="w-full max-w-sm bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md relative">
      <div class="absolute top-4 right-4">
        <button @click="toggleDarkMode" class="p-2">
          <i v-if="isDarkMode" class="bi bi-moon-fill text-white"></i>
          <i v-else class="bi bi-sun-fill text-gray-800"></i>
        </button>
      </div>
      ...
      <p class="text-xl sm:text-xl font-semibold text-center text-gray-800 dark:text-gray-200 mb pb-0">Login to your Wotnot
        account</p>
